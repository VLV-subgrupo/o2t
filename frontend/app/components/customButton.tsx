...
const CustomButton = ({ onClick }: Prop) => {
    return ( 
        <div data-testid='custombutton' onClick={onClick} className="group bg-secondary flex h-[48px] self-center rounded-full px-[24px] items-center gap-4 cursor-pointer hover:pr-4 select-none">
